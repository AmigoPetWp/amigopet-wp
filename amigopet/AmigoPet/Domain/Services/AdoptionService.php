...
class AdoptionService
{
    ...
    public function reviewAdoption(
        ...
        if (!$adoption) {
            throw new \InvalidArgumentException(esc_html__("Adoção não encontrada", 'amigopet'));
        }
    ...
    public function markPaymentAsPaid(int $adoptionId): void
    {
        ...
        if (!$payment) {
            throw new \InvalidArgumentException(esc_html__("Pagamento não encontrado", 'amigopet'));
        }
