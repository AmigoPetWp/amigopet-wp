...
class PublicController
{
    ...
    public function enqueueAssets(): void
    {
        ...
        wp_enqueue_style(
            'amigopet-public',
            AMIGOPET_PLUGIN_URL . 'AmigoPet/assets/css/public.css',
            [],
            AMIGOPET_VERSION
        );
        ...
        wp_enqueue_script(
            'jquery-mask',
            AMIGOPET_PLUGIN_URL . 'AmigoPet/assets/js/lib/jquery.mask.min.js',
            ['jquery'],
            '1.14.16',
            true
        );
        ...
        wp_enqueue_script(
            'jquery-validate',
            AMIGOPET_PLUGIN_URL . 'AmigoPet/assets/js/lib/jquery.validate.min.js',
            ['jquery'],
            '1.19.5',
            true
        );
        ...
        wp_enqueue_script(
            'amigopet-public',
            AMIGOPET_PLUGIN_URL . 'AmigoPet/assets/js/public.js',
        ...
        wp_localize_script('amigopet-public', 'apwp', [
            ...
            'i18n' => [
                'error' => esc_html__('Erro ao processar requisição.', 'amigopet'),
                'success' => esc_html__('Operação realizada com sucesso.', 'amigopet')
            ]
        ]);
    }
    ...
    public function renderPetsGrid($atts): string
    {
        ...
        ob_start();
        require AMIGOPET_PLUGIN_DIR . 'AmigoPet/Views/public/pets-grid.php';
        return ob_get_clean();
    }
    ...
    public function renderEventsGrid($atts): string
    {
        ...
        ob_start();
        require AMIGOPET_PLUGIN_DIR . 'AmigoPet/Views/public/events-grid.php';
        return ob_get_clean();
    }
    ...
    public function renderAdoptionForm($atts): string
    {
        ...
        ob_start();
        require AMIGOPET_PLUGIN_DIR . 'AmigoPet/Views/public/adoption-form.php';
        return ob_get_clean();
    }
    ...
    public function renderDonationForm($atts): string
    {
        ...
        ob_start();
        require AMIGOPET_PLUGIN_DIR . 'AmigoPet/Views/public/donation-form.php';
        return ob_get_clean();
    }
    ...
    public function renderVolunteerForm($atts): string
    {
        ...
        ob_start();
        require AMIGOPET_PLUGIN_DIR . 'AmigoPet/Views/public/volunteer-form.php';
        return ob_get_clean();
    }
    ...
    public function submitAdoption(): void
    {
        ...
        if (!is_user_logged_in()) {
            wp_send_json_error(esc_html__('Você precisa estar logado para adotar.', 'amigopet'));
        }

        $petId = (int) ($_POST['pet_id'] ?? 0);
        if (!$petId) {
            wp_send_json_error(esc_html__('Pet não encontrado.', 'amigopet'));
        }

        try {
            $adoptionService = new \AmigoPetWp\Domain\Services\AdoptionService(
            ...
            wp_send_json_success([
                ...
                'message' => esc_html__('Solicitação de adoção enviada com sucesso.', 'amigopet')
            ]);
        } catch (\Exception $e) {
    ...
    public function submitDonation(): void
    {
        ...
        if (!$organizationId) {
            wp_send_json_error(esc_html__('Organização não encontrada.', 'amigopet'));
        }

        try {
            $donationService = new \AmigoPetWp\Domain\Services\DonationService(
            ...
            wp_send_json_success([
                ...
                'message' => esc_html__('Doação registrada com sucesso.', 'amigopet')
            ]);
        } catch (\Exception $e) {
            wp_send_json_error($e->getMessage());
        }
    ...
    public function submitVolunteer(): void
    {
        ...
        if (!is_user_logged_in()) {
            wp_send_json_error(esc_html__('Você precisa estar logado para se voluntariar.', 'amigopet'));
        }
        ...
        try {
            $volunteerService = new \AmigoPetWp\Domain\Services\VolunteerService(
            ...
            wp_send_json_success([
                ...
                'message' => esc_html__('Cadastro de voluntário realizado com sucesso.', 'amigopet')
            ]);
        } catch (\Exception $e) {
            wp_send_json_error($e->getMessage());
        }
    ...
    public function printAdoptionTerms(): void
    {
        ...
        if (!is_user_logged_in()) {
            wp_die(esc_html__('Você precisa estar logado para acessar o termo.', 'amigopet'));
        }
        ...
        require AMIGOPET_PLUGIN_DIR . 'AmigoPet/Views/public/print-adoption-terms.php';
        exit;
    }
}