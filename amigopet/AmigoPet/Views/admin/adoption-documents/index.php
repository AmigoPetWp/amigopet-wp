            ...
            <table class="wp-list-table widefat fixed striped">
                ...
                <tbody>
                     foreach ($documents as $document): ?>
                        <tr>
                            <td> echo esc_html($document->getTitle()); ?></td>
                            <td> echo esc_html($document->getTemplate()); ?></td>
                            <td>
                                <span class="apwp-status-badge status- echo esc_attr($document->getStatus()); ?>">
                                     echo esc_html($document->getStatusName()); ?>
                                </span>
                            </td>
                            <td> echo esc_html(implode(', ', $document->getRequiredFields())); ?></td>
                            <td> echo esc_html($document->getUpdatedAt()->format('d/m/Y H:i')); ?></td>
                            <td>
                                <div class="row-actions">
                                    <span class="edit">
                                        <a href="#" class="apwp-edit-document" data-id=" echo esc_attr($document->getId()); ?>">
                                            Editar
                                        </a> |
                                    </span>
                                    <span class="preview">
                                        <a href="#" class="apwp-preview-document" data-id=" echo esc_attr($document->getId()); ?>">
                                            Prévia
                                        </a> |
                                    </span>
                                    <span class="download">
                                        <a href=" echo esc_url(add_query_arg([
                                    ...
                                    <span class="delete">
                                        <a href="#" class="apwp-delete-document" data-id=" echo esc_attr($document->getId()); ?>">
                                            Excluir
                                        </a>
                                    </span>
                                </div>
        ...
        <div class="apwp-form-container">
            ...
            <form method="post">
                ...
                <input type="hidden" name="id" value="">
                 wp_nonce_field('apwp_adoption_documents'); ?>
                            ...
                            <select id="template" name="template" required>
                                <option value="">Selecione...</option>
                                 foreach ($templates as $key => $name): ?>
                                    <option value=" echo esc_attr($key); ?>">
                                         echo esc_html($name); ?>
                                    </option>
                                 endforeach; ?>
                            </select>
