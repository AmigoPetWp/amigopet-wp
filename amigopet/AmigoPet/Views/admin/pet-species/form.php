...
$species = $apwp_data['species'] ?? null;
$action = $species ? 'edit' : 'new';
$title = $action === 'edit' ? esc_html__('Editar Espécie', 'amigopet') : esc_html__('Nova Espécie', 'amigopet');
?>
...
<div class="wrap">
    ...
    <form method="post" action="">
         wp_nonce_field('amigopet_save_pet_species'); ?>
        <input type="hidden" name="action" value=" echo esc_attr($action); ?>">
         if ($species): ?>
            <input type="hidden" name="id" value=" echo esc_attr($species->getId()); ?>">
         endif; ?>
            ...
            <tr>
                ...
                <td>
                    <input name="name" type="text" id="name" 
                           value=" echo esc_attr($species ? $species->getName() : ''); ?>" 
            ...
            <tr>
                ...
                <td>
                    <select name="status" id="status">
                        <option value="active"  selected($species ? $species->getStatus() : 'active', 'active'); ?>>
                             esc_html_e('Ativo', 'amigopet'); ?>
                        </option>
                        <option value="inactive"  selected($species ? $species->getStatus() : '', 'inactive'); ?>>
