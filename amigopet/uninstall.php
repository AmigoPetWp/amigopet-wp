...
function apwp_uninstall() {
    ...
    // Only do cleanup if the AMIGOPET_DELETE_DATA constant is true
    // This constant can be defined in wp-config.php
    if (!defined('AMIGOPET_DELETE_DATA') || !AMIGOPET_DELETE_DATA) {
        return;
    }
    ...
    $apwp_upload_dir = $upload_dir['basedir'] . '/amigopet';
...
function apwp_remove_directory($dir) {
    ...
    return (bool) $wp_filesystem->rmdir($dir, true);
}
