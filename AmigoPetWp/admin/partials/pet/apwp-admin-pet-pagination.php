<?php
/**
 * Template de paginação para a listagem de pets
 *
 * @package AmigoPet_Wp
 */
...
$total_pages = APWP_Pet_Model::get_total_pages(array(
...
<div class="row">
    <div class="col-sm-12 col-md-5">
        <div class="dataTables_info" role="status" aria-live="polite">
            ...
            $end = min($start + 9, APWP_Pet_Model::get_total_pets());
            printf(
                esc_html__('Mostrando %1$d até %2$d de %3$d registros', 'amigopet-wp'),
                $start,
                $end,
                APWP_Pet_Model::get_total_pets()
            );
            ?>
        </div>
    </div>
