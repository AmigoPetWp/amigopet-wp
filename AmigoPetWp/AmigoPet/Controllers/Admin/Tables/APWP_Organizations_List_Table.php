...
class APWP_Organizations_List_Table extends \WP_List_Table {
    ...
    public function __construct() {
        parent::__construct([
            'singular' => __('Organização', 'amigopet-wp'),
            'plural'   => __('Organizações', 'amigopet-wp'),
            'ajax'     => false
        ]);
    ...
    public function get_columns() {
        return [
            ...
            'email'     => __('Email', 'amigopet-wp'),
            'phone'     => __('Telefone', 'amigopet-wp'),
            'address'   => __('Endereço', 'amigopet-wp'),
            'status'    => __('Status', 'amigopet-wp'),
            'created_at' => __('Criado em', 'amigopet-wp')
        ];
    }
    ...
    public function column_name($item) {
        $actions = [
            ...
            'delete' => sprintf(
                ...
                __('Tem certeza que deseja excluir esta organização?', 'amigopet-wp'),
    ...
    public function get_bulk_actions() {
        return [
            ...
            'activate' => __('Ativar', 'amigopet-wp'),
            'deactivate' => __('Desativar', 'amigopet-wp')
        ];
    }
