    ...
    <div class="apwp-summary-cards">
        <div class="apwp-card">
            ...
            <div class="apwp-card-content">
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="adoptions-total"><?php echo esc_html($data['adoptions']['total'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Total', 'amigopet-wp'); ?></span>
                </div>
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="adoptions-pending"><?php echo esc_html($data['adoptions']['pending'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Pendentes', 'amigopet-wp'); ?></span>
                </div>
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="adoptions-approved"><?php echo esc_html($data['adoptions']['approved'] ?? 0); ?></span>
        ...
        <div class="apwp-card">
            ...
            <div class="apwp-card-content">
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="donations-total">R$ <?php echo number_format(($data['donations']['total_amount'] ?? 0), 2, ',', '.'); ?></span>
                    <span class="apwp-stat-label"><?php _e('Total em Dinheiro', 'amigopet-wp'); ?></span>
                </div>
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="donations-count"><?php echo esc_html($data['donations']['total'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Total de Doações', 'amigopet-wp'); ?></span>
                </div>
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="donations-donors"><?php echo esc_html($data['donations']['unique_donors'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Doadores Únicos', 'amigopet-wp'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="apwp-card">
            ...
            <div class="apwp-card-content">
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="events-total"><?php echo esc_html($data['events']['total'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Total', 'amigopet-wp'); ?></span>
                </div>
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="events-upcoming"><?php echo esc_html($data['events']['upcoming'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Próximos', 'amigopet-wp'); ?></span>
                </div>
                <div class="apwp-stat">
                    <span class="apwp-stat-value" id="events-participants"><?php echo esc_html($data['events']['total_participants'] ?? 0); ?></span>
                    <span class="apwp-stat-label"><?php _e('Participantes', 'amigopet-wp'); ?></span>
                </div>
            </div>
        </div>
    </div>
