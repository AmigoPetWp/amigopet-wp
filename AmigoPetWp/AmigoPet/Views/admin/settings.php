            ...
            <div class="apwp-settings-section">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="text" id="organization_name" name="organization_name" class="regular-text" value="<?php echo esc_attr(get_option('apwp_organization_name')); ?>">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
...
jQuery(document).ready(function($) {
    ...
    $('#apwp-settings-form').on('submit', function(e) {
        ...
        formData.append('action', 'apwp_save_settings');
        formData.append('nonce', $('#apwp_settings_nonce').val());
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alert(response.data.message || 'Erro ao salvar configurações');
                }
            },
            error: function() {
